...
/**  This class is created to keep record of student's name, id, grade, total fee, fee paid, remaining fee */
 ...
 * Total fees for every Student is $20,000.
...
/**
 * This setter is updating the fee of the student by keep adding the fee to the recentFeePaid 
 * School is earning by the fee of students and it is updating updateTotalMoneyEarned.
