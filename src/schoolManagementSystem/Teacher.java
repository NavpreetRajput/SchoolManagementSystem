...
/**
 * This class is created to keep the record of teacher's name, id, salary and salary earned by them.
 */
 ...
 * Initially, salary earned by the teacher is 0
 */
...
public void setSalary(double salary){
    ...
    System.out.println("Now, the salary of "+getTName()+" is incremented by "+incrementedBy+" and the new salary is "+this.salary+"\n");
